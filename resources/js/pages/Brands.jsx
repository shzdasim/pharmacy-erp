...
export default function Brands() {
  ...
  const handleFileChange = (e) => {
    ...
    setPreview(file ? URL.createObjectURL(file) : (editingId ? (preview || null) : null));
  };
                      ...
                      <div className="flex gap-2 justify-center">
                        ...
                        <Guard when={can.delete}>
                          <button
                            ...
                            onKeyDown={(e) => handleButtonKeyDown(e, () => used ? toast.error("Cannot delete: brand is used by products.") : handleDelete(b))}
                            tabIndex={0}
                            disabled={used}

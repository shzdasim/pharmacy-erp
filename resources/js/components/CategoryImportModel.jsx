...
export default function CategoryImportModal({ open, onClose, onImported }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white w-[min(700px,95vw)] rounded-2xl shadow-xl overflow-hidden">
        <div className="px-6 py-4 border-b flex items-center justify-between">
          <h2 className="text-xl font-semibold">Import Categories (CSV)</h2>
          ...
          {!res ? (
            <div className="space-y-3">
              <label className="block text-sm font-medium">
                Choose CSV file <span className="text-gray-500">(header: name)</span>
              </label>
              ...
              <div className="text-sm text-gray-600">
                Need a sample?{" "}
                <a href="/api/categories/import/template" className="text-blue-600 underline">
                  ...
                  <div className="max-h-56 overflow-auto border rounded">
                    <table className="w-full text-sm">
                      <thead className="bg-gray-50 sticky top-0">
                        <tr><Th>Row#</Th><Th>Name</Th><Th>Errors</Th></tr>
                      </thead>
                      <tbody>
        ...
        <div className="px-6 py-4 border-t flex items-center justify-between">
          {!res ? (
            <>
              <div className="text-sm text-gray-600">CSV header: <code>name</code></div>

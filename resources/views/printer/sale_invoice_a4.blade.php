...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .header {
    display: flex; align-items: center; gap: 16px; border-bottom: 1px solid var(--border); padding-bottom: 12px;
  }
  ...
  .title-row {
    display: flex; justify-content: space-between; align-items: baseline; margin: 14px 0 6px;
  }
  ...
  table {
    width: 100%; border-collapse: collapse; margin-top: 8px; font-size: 12px; table-layout: fixed;
  }
  thead th {
    text-align: left; border-bottom: 1px solid var(--border); padding: 8px 6px; font-size: 12px;
  }
  tbody td {
    border-bottom: 1px dashed #e0e0e0; padding: 7px 6px; vertical-align: top; word-wrap: break-word;
  }
  tfoot td {
  ...
  .footer-total {
    width: 50%; margin-left: auto; border: 1px solid var(--border); border-radius: 6px; overflow: hidden;
  }
  ...
  .thankyou { margin-top: 14px; font-size: 12px; text-align: center; }
</style>
</head>
<body>
...
<div class="page">
  ...
  {{-- Footer Totals --}}
  <div class="footer-total" style="margin-top:12px;">
